...
namespace MapControl
{
    public partial class MapPath : Path
    {
        ...
        protected void DataCollectionPropertyChanged(AvaloniaPropertyChangedEventArgs e)
        {
        ...
        protected void AddPolylineLocations(PathFigures pathFigures, IEnumerable<Location> locations, double longitudeOffset, bool closed)
        {
            if (locations.Count() >= 2)
            {
                ...
                else
                {
                    ...
                    var viewport = new Rect(0, 0, ParentMap.Bounds.Width, ParentMap.Bounds.Height);
